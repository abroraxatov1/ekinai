...
st.markdown(f'<span class="ekin">Ekin</span> <span class="ai">AI</span> <span class="matn"> - Tuproq tarkibi asosida ekinlarning hosildorligini aniqlashning sun\'iy intellekt tizimi</span>', unsafe_allow_html=True)
