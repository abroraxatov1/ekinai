...
st.markdown(f'<span class="ekin" style="text-align:center;">Ekin</span> <span class="ai">AI</span> <span class="matn"> - <span class="ekin"> Tuproq tarkibi asosida ekinlarning hosildorligini aniqlashning </span> <span class="ai"> sun\'iy intellekt tizimi</span> </span>', unsafe_allow_html=True)
