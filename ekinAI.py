...
st.markdown(f'<div class="text"><span class="ekin">Ekin</span> <span class="ai">AI</span> <span class="matn"> <span class="ekin"> - Tuproq tarkibi asosida ekinlar hosildorligini aniqlashning </span> <span class="ai"> sun\'iy intellekt </span> <span class="ekin"> tizimi </span> </span></div>', unsafe_allow_html=True)
...
with col1:
    st.markdown('<div class="slider-label">Qatlam (sm)<span class="tooltiptext">' + tooltips["Qatlam (sm)"] + '</span></div>', unsafe_allow_html=True)
